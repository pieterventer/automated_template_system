...
copy_file "$base_dir/$company/${company}_Competency_db/${company}_ResourcesAndCompetencies_db.xlsm"
copy_file "$base_dir/$company/${company}_Competency_db/${company}_Competency_db.xlsm"
