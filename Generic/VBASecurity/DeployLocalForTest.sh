...
copy_file "$base_dir/Generic/VBASecurity/ChangeWordMacroSecuritySettings.sh"
copy_file "$base_dir/Generic/VBASecurity/Reg-Office-Base.reg"
copy_file "$base_dir/Generic/VBASecurity/Reg-Office-${company}.reg"
copy_file "$base_dir/Generic/VBASecurity/close_word.vbs"
copy_file "$base_dir/Generic/VBASecurity/close_doc.vbs"
